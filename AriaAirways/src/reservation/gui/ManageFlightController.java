 ...
 /*    public void confirmFlights(ActionEvent event) throws IOException {
	...
	*/     
	 ...
	 try {
			...
			flight.setDepartureCity(origin.getSelectionModel().getSelectedItem());
			flight.setDestinationCity(destination.getSelectionModel().getSelectedItem());
			flight.setDepartureDate(departureTime.getText());
			flight.setCapacity((capacity.getText());
			flight.setPassengerCount(pass.getText());
